...
<section class="hero-wrap hero-wrap-2" style="background-image: url('images/126.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h2 class="mb-3 bread"> Nos Conseils 21th</h2>
          </div>
        </div>
      </div>
    </section>
